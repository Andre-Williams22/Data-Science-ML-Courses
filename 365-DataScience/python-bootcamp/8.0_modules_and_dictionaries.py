...
# #
# # #
# # x,y = zip(*letter_count.items()) # zip pacts these pairs and grabs all the keys and values so they can be visualized
# # #
# # plt.bar(x,y)
# # plt.show()
# ##
...
#    if k.isalpha(): # if k is a letter
#        letter_count_clean[k] = v # add it to the dictionary
